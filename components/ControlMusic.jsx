...
export default function ControlMusic() {
    ...
    useEffect(() => {
        window.electronAPI.RecieveFromElectron("music-playable", async (event, music) => {
        ...
        <div className="w-96 h-14 px-8 flex-col justify-center items-center gap-4 inline-flex">
            ...
            <div className="self-stretch justify-start items-center gap-8 inline-flex">
                ...
                >
                    <div
                        id="progress-bar"
                        className="h1- w-1 rounded-full bg-white absolute top-1/2 transform -translate-y-1/2" 
                        style={{
